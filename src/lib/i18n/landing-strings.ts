...
const LANDING_STRINGS = {
  es: {
    ...
    integrationsStripCaption: 'Conecta Shopify, Mercado Libre y más canales de venta',
  ...
  en: {
    ...
    integrationsStripCaption: 'Connect Shopify, Mercado Libre, and more sales channels',
