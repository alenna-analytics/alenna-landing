...
const ES: IntegrationDetailContent = {
  ...
  metaDescription:
    'Conecta Amazon Seller (SP-API) a Alenna: pedidos, fees, inventario y margen junto a Shopify y Mercado Libre.',
  pageTitle: 'Amazon',
  eyebrow: 'Integración ecommerce',
  title: 'Amazon seller analytics con fees reales',
  intro:
    'Conecta tu cuenta de vendedor Amazon y ve pedidos, comisiones e inventario en el mismo P&L que Shopify y Mercado Libre — sin hojas de cálculo.',
  bullets: [
    ...
    'Inventario y catálogo de listings junto al resto de tus canales.',
  ],
  overviewTitle: 'Marketplace seller, en un solo panel',
  overviewBody:
    'Los reportes de Seller Central no cruzan tu tienda propia ni MELI. Alenna usa Selling Partner API en solo lectura para traer pedidos, fees e inventario y calcular rentabilidad consolidada.',
  ...
  kpis: [
    ...
    'Comparativa vs Shopify y Mercado Libre',
  ],
...
const EN: IntegrationDetailContent = {
  ...
  metaDescription:
    'Connect Amazon Seller (SP-API) to Alenna: orders, fees, inventory, and margin next to Shopify and Mercado Libre.',
  pageTitle: 'Amazon',
  eyebrow: 'Ecommerce integration',
  title: 'Amazon seller analytics with real fees',
  intro:
    'Connect your Amazon seller account and see orders, commissions, and inventory in the same P&L as Shopify and Mercado Libre — without spreadsheets.',
  bullets: [
    'Orders and line items without buyer personal data.',
    'Channel fees and commissions for margin closer to reality.',
    'Inventory and listings next to your other channels.',
  ],
  overviewTitle: 'Marketplace seller, one panel',
  overviewBody:
    'Seller Central reports do not cross your owned store or MELI. Alenna uses Selling Partner API read-only to pull orders, fees, and inventory and compute consolidated profitability.',
  ...
  kpis: [
    ...
    'Compare vs Shopify and Mercado Libre',
  ],
