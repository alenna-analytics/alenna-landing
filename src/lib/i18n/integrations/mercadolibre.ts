...
const ES: IntegrationDetailContent = {
  ...
  metaDescription:
    'Conecta Mercado Libre a Alenna: pedidos, publicaciones e inventario con margen real junto a Shopify y Amazon.',
  pageTitle: 'Mercado Libre',
  eyebrow: 'Integración ecommerce',
  title: 'Mercado Libre con rentabilidad clara',
  intro:
    'Conecta tu cuenta de vendedor MELI y ve ventas, publicaciones e inventario en el mismo panel que Shopify y Amazon — listo para COGS y margen.',
  bullets: [
    'Pedidos y envíos en solo lectura para métricas de ventas.',
    'Publicaciones e inventario sincronizados al catálogo de Alenna.',
    'Base para TACoS cuando también conectas Mercado Libre Ads.',
  ],
  overviewTitle: 'El marketplace que más pesa en MX, en tu P&L',
  overviewBody:
    'Seller Center de MELI no consolida tu tienda Shopify ni Amazon. Alenna conecta OAuth con PKCE, sincroniza pedidos y catálogo en solo lectura y los mete en reportes multicanal.',
  kpisTitle: 'Qué puedes ver',
  kpis: [
    'Ventas netas Mercado Libre',
    'Margen tras costos',
    'Inventario y publicaciones',
    'Comparativa vs otros canales',
...
const EN: IntegrationDetailContent = {
  ...
  metaDescription:
    'Connect Mercado Libre to Alenna: orders, listings, and inventory with real margin next to Shopify and Amazon.',
  pageTitle: 'Mercado Libre',
  eyebrow: 'Ecommerce integration',
  title: 'Mercado Libre with clear profitability',
  intro:
    'Connect your MELI seller account and see sales, listings, and inventory in the same panel as Shopify and Amazon — ready for COGS and margin.',
  bullets: [
    'Orders and shipments read-only for sales metrics.',
    'Listings and inventory synced into Alenna’s catalog.',
    'Foundation for TACoS when you also connect Mercado Libre Ads.',
  ],
  overviewTitle: 'The marketplace that matters in MX, in your P&L',
  overviewBody:
    'MELI Seller Center does not consolidate your Shopify store or Amazon. Alenna connects via OAuth with PKCE, syncs orders and catalog read-only, and feeds multichannel reports.',
  kpisTitle: 'What you can see',
  kpis: [
    'Mercado Libre net sales',
    'Margin after costs',
    'Inventory and listings',
    'Compare vs other channels',
