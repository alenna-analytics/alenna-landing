...
const LANDING_STRINGS = {
  es: {
    ...
    integrationGoogleAds: 'Google Ads',
    ...
    integrationAdsSoon: 'Meta Ads',
    integrationsStripCaption: 'Integraciones',
    integrationsViewDetail: 'Ver →',
    integrationsBack: 'Integraciones',
    integrationsCaption:
      'Conectamos Amazon, Shopify y Mercado Libre, más Amazon Ads, Mercado Libre Ads y Google Ads, para que ventas, costos y publicidad vivan en un solo lugar.',
  ...
  en: {
    ...
    integrationsCaption:
      'We connect Amazon, Shopify, and Mercado Libre, plus Amazon Ads, Mercado Libre Ads, and Google Ads, so sales, costs, and advertising live in one place.',
...
const LANDING_FAQ: Record<Language, LandingFaqItem[]> = {
  es: [
    ...
    },
    {
      ...
      answer:
        'Hoy puedes conectar Amazon, Shopify, Mercado Libre, Amazon Ads, Mercado Libre Ads y Google Ads. Meta Ads está en el catálogo, todavía no abierto.',
      href: INTEGRATIONS_PATH,
      linkLabel: 'Ver integraciones',
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      answer:
        'Today you can connect Amazon, Shopify, Mercado Libre, Amazon Ads, Mercado Libre Ads, and Google Ads. Meta Ads is in the catalog, not open yet.',
      href: INTEGRATIONS_PATH,
      linkLabel: 'See integrations',
    },
    {
